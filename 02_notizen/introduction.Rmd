...
# Import ALLBUS 2018 
df <- readRDS("allbus_2018_small.rda")
...
Most of these steps take place in a traditional type of model as well, even if they are not usually explicated. Steps 4 and 5, model evaluation and respecification, are arguably specific to SEM and can be seen as 

## Specification 

*Specification* is the first step to any SEM model. In fact, it is the first step in just about any statistical analysis, but the *flexibility of SEM makes it much more involved*. 
...
Estimation is a very complicated topic and requires a good grasp of algebra, calculus and statistics to fully understand. We can look at it in broad sense in this workshop; those interested can look at the xxxnotes on maximum likelihood estimation in SEM as well as @Ferron2007; @Bollen1989 for a much more detailed explanation.  
